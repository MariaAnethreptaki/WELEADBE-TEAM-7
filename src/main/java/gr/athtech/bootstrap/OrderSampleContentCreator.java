...
public class OrderSampleContentCreator extends BaseComponent implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		logger.info("Does customer exist? {}.", (accountService.findByEmail("c.giannacoulis@codehub.gr") != null));
		...
		Account firstCustomer = accountService.findByEmail("c.giannacoulis@codehub.gr");
		...
		Customer secondCustomer = accountService.get(2L);
		...
		Customer thirdCustomer = accountService.findByEmail("malcolm.paker@gmailx.com");
		...
		Customer fourthCustomer = accountService.findByEmail("terry.jones@gmailx.com");
		...
		// customer and order
		Customer c5 = accountService.get(5L);
		...
		// customer and order
		Customer c6 = accountService.get(6L);
		...
		// customer and order
		Customer c7 = accountService.get(7L);
		...
		// customer and order
		Customer c8 = accountService.get(8L);
		...
		// customer and order
		Customer c9 = accountService.get(9L);
		...
		// customer and order
		Customer c10 = accountService.get(10L);
