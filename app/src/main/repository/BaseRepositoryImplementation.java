...
import main.base.BaseComponent;
import main.domain.BaseModel;
...
public abstract class BaseRepositoryImplementation<T extends BaseModel> extends BaseComponent implements BaseService<T, Long> {
